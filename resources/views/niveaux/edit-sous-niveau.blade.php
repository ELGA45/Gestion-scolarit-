    ...
    <div class="max-w-3xl mx-auto">
        ...
        <div class="bg-white rounded-2xl shadow-md border border-gray-100 p-8">
            ...
            <h2 class="text-2xl font-semibold text-gray-800 mb-6">
                Modifier Sous-Niveau
            </h2>

            <p class="mb-6 text-gray-500">
                Niveau : <span class="font-semibold text-blue-600">{{ $sousNiveau->niveau->nom }}</span>
            </p>
            ...
            <form action="{{ route('sousNiveaux.update', $sousNiveau) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input type="text" name="code" value="{{ old('code', $sousNiveau->code) }}"
                ...
                <div>
                    ...
                    <input type="text" name="nom" value="{{ old('nom', $sousNiveau->nom) }}"
                        class="w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-blue-500 focus:outline-none"
                        required>
                </div>
